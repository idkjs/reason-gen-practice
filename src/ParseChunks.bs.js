...
var Gen$ReasonGenPractice = require("./gen/Gen.bs.js");
...
function linesToChunks(lines) {
  var sentinel = Gen$ReasonGenPractice.singleton("## Will be discarded");
  var linesWithSentinel = Gen$ReasonGenPractice.append(lines, sentinel);
  var genWithOpts = Gen$ReasonGenPractice.unfold_scan(unfoldScanFunc, {
        title: "PREFIX",
        body: /* [] */0
      }, linesWithSentinel);
  return Gen$ReasonGenPractice.filter_map((function (x) {
                return x;
              }), genWithOpts);
}
...
/* Gen-ReasonGenPractice Not a pure module */

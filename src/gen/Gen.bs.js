...
var GenMList$ReasonGenPractice = require("./GenMList.bs.js");
...
function of_gen(caching, max_chunk_size, g) {
  ...
  return function (param) {
    ...
    if (mlist !== undefined) {
      return GenMList$ReasonGenPractice.to_gen(Caml_option.valFromOption(mlist));
    }
    var mlist$1 = GenMList$ReasonGenPractice.of_gen_lazy(max_chunk_size, caching, g);
    cached.contents = Caml_option.some(mlist$1);
    return GenMList$ReasonGenPractice.to_gen(mlist$1);
  };
}
...
function persistent(gen) {
  var l = GenMList$ReasonGenPractice.of_gen(gen);
  return function (param) {
    return GenMList$ReasonGenPractice.to_gen(l);
  };
}

function persistent_lazy(caching, max_chunk_size, gen) {
  var l = GenMList$ReasonGenPractice.of_gen_lazy(max_chunk_size, caching, gen);
  return function (param) {
    return GenMList$ReasonGenPractice.to_gen(l);
  };
}
